...
I am a Senior Decision Scientist at ZipRecruiter based in Oakland, CA where I advise on experimental design and conduct research to drive business outcomes. I also work on improving experimental practice and expanding the use and improving the credibility of observational causal inference. I am also a researcher in the [Practical Causal Inference Lab](https://www.practicallycausal.com/) at UCLA. I hold a PhD in Statistics from UCLA, have worked as a researcher at Twitter, have a background in economic consulting and applied econometrics, and did my undergrad at Boston College, where I studied pure mathematics and economics.
...
At Twitter, I investigated whether there is differential algorithmic amplification of elected officials from different political parties using tools of causal inference. My study aimed to uncover algorithmic bias favoring certain political parties over others; (perception of) bias affects trust in and bottom line for Twitter.
