...
I’m a PhD student in [Statistics at UCLA](http://statistics.ucla.edu/) working with [Chad Hazlett](https://www.chadhazlett.com/). My research focuses on developing theory and methods in causal inference focused on sample selection bias, sensitivity analysis, and novel identification strategies. I am also interested in how machine learning approaches can be used in causal inference and how causality can be introduced into machine learning. 

Before UCLA, I worked at [Charles River Associates](http://www.crai.com/) for 6 years conducting empirical analyses related to mergers, acquisitions, market dynamics, and antitrust litigation. Much of my work focused in the healthcare space, but spanned a variety of industries. I built expertise in working with large databases (up to a few terabytes) to draw insights for clients and understand markets using a variety of data science, statistical, and econometric tools and methods. 
